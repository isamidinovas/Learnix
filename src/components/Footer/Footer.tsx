        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mb-4 text-sm">
              ...
              жана ЖС жардамчысы бар билим берүү платформасы.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[
                ["Видео чечимдер", "/videos"],
                ["PDF чат", "/pdf-chat"],
                ["ЖС Жардамчы", "/ai-assistant"],
                ["Окуу китептери", "/textbooks"],
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[
                ["Колдонуу шарттары", "/terms"],
                ["Купуялык саясаты", "/privacy"],
                ["Cookie саясаты", "/cookies"],
                ["DMCA", "/dmca"],
                ["Академиялык честность", "/academic-integrity"],
              ].map(([name, url]) => (
                <li key={name}>
                  <a href={url} className="hover:text-white transition-colors">
                    {name}
